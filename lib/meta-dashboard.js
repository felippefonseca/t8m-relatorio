...
async function fetchAccountSnapshot(accountId, options) {
  ...
  return graphFetch(`/${accountId}`, { fields: accountFields }, options);
}
...
function buildFinanceSnapshot({ amountSpent, apiBalance, currency, isPrepay, spendCap }) {
