...
O PDF sai com um **tema claro** próprio (fundo branco, texto escuro), otimizado para leitura e impressão — independente de qualquer configuração. A tela continua com o fundo preto.

Ao clicar, na janela que abrir:
1. Em **Destino**, escolha **Salvar como PDF**.
2. Em **Mais configurações**, desmarque **Cabeçalhos e rodapés** (tira a data/URL das bordas).
3. Clique em **Salvar**.
